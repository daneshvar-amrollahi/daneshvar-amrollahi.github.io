...
It was Thanksgiving holiday week, and Black Friday sales were in full swing. What better time to snag a PS5? But when I got it home, I needed to register its MAC address on my university's network to get online. Unfortunately, the registration site ([iprequest.stanford.edu](https://iprequest.stanford.edu/)) was down. My laptop, however, was already registered and had internet access through the university WiFi. To work around the issue, I turned my laptop into a WiFi hotspot and shared the connection with my PS5. Here’s how I made it work.
...
1. Reconnect using:
   ...
   ```
   - **Explanation:** This command re-establishes your laptop’s connection to the university network, allowing it to share the internet connection with the PS5 via the hotspot.
